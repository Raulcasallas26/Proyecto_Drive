...
const routes = [
    ...
    { path: "/home", component: home, meta: { rol: ["Super", "Gestor", "Admin", "Instructor"] }, beforeEnter: auth },
    { path: "/roles", component: roles, meta: { rol: ["Super", "Gestor", "Admin", "Instructor"] }, beforeEnter: auth },
    { path: "/guias", component: guias, meta: { rol: ["Super", "Gestor", "Admin", "Instructor"] }, beforeEnter: auth },
    { path: "/usuarios", component: usuarios, meta: { rol: ["Super", "Gestor", "Admin", "Instructor"] }, beforeEnter: auth },
    ...
    { path: "/desarrolloCurricular", component: desarrolloCurricular, meta: { rol: ["Super", "Gestor", "Admin", "Instructor"] }, beforeEnter: auth },
    { path: "/instrumentosEvaluacion", component: instrumentosEvaluacion, meta: { rol: ["Super", "Gestor", "Admin", "Instructor"] }, beforeEnter: auth },
]
